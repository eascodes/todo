...
import "./style.css";
import { buildModal, reloadModal } from "./modal";
    ...
    if (localStorage.length === 0) {
      const backpackTrip = {
        list: [
          {
            title: "Plan route",
            description: "Use guidebook to plan hiking route",
            dueDate: format(new Date("04/05/2023"), "MM-dd-yy"),
            priority: 1,
            status: 0,
          },
          {
            title: "Plan meals",
            description: "Plan meals to meet calorie needs",
            dueDate: format(new Date("05/01/2023"), "MM-dd-yy"),
            priority: 0,
            status: 0,
          },
          {
            title: "Pack gear",
            description: "Pack gear needed for 10 day trip",
            dueDate: format(new Date("05/15/2023"), "MM-dd-yy"),
            status: 0,
          },
        ],
      ...
      const loveDog = {
        list: [
          {
            title: "Cuddle",
            description: "Cuddle with my dog",
            dueDate: format(new Date("12/25/2022"), "MM-dd-yy"),
            priority: 1,
            status: 0,
          },
        ],
